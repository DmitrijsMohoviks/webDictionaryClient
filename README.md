...
2. Add following snippet there:
        ...
        <datasource jndi-name="java:jboss/datasources/webDictionaryClientDataSource" pool-name="webDictionaryClientDataSource" enabled="true" use-java-context="true">
            <connection-url>jdbc:h2:~/webDictionaryClientDatabase;AUTO_SERVER=TRUE</connection-url>
            <driver>h2</driver>
            <security>
...
2. Add following snippet there:
        ...
        <security-domain name="webDictionaryClientSecurityDomain" cache-type="default">
            <authentication>
                <login-module code="Database" flag="required">
                    <module-option name="dsJndiName" value="java:jboss/datasources/webDictionaryClientDataSource"/>
